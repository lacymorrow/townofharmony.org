...
import { getWaitlistEntries, getWaitlistStats } from "@/server/services/waitlist-service";
    ...
    <div className="space-y-8">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Latest signups with their project details</CardDescription>
        </CardHeader>
        <CardContent>
