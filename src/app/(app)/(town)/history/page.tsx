...
export const metadata: Metadata = {
	title: "History of Harmony, NC | Town of Harmony",
	description:
		"Explore the history of Harmony, North Carolina — from its 1846 camp meeting origins to incorporation in 1927. Discover local landmarks and milestones.",
	alternates: { canonical: `${siteConfig.url}/history` },
	openGraph: {
		title: "History of Harmony, NC",
		description:
			"Explore the history of Harmony, North Carolina — from its 1846 camp meeting origins to incorporation in 1927. Discover local landmarks and milestones.",
