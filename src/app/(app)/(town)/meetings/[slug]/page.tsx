...
export async function generateMetadata({
	...
	const description = meeting.minutes
		? meeting.minutes.substring(0, 160)
		: `Official meeting of the Town of Harmony Board of Aldermen held on ${dateStr} at ${meeting.location}. View the agenda and meeting minutes.`;
	return {
		title: `${meeting.title} | Town of Harmony, NC`,
		description,
		alternates: { canonical: `${siteConfig.url}/meetings/${meeting.slug}` },
		openGraph: {
			title: `${meeting.title} | Town of Harmony, NC`,
			description,
			url: `${siteConfig.url}/meetings/${meeting.slug}`,
		},
	};
}
