...
export const metadata: Metadata = {
	title: "Emergency Information | Town of Harmony, NC",
	description:
		"Emergency services, contacts, and preparedness resources for the Town of Harmony, NC. Find emergency contacts, active alerts, and safety information for Harmony, North Carolina.",
	alternates: { canonical: `${siteConfig.url}/emergency` },
	openGraph: {
		title: "Emergency Information | Town of Harmony, NC",
		description:
			"Emergency services, contacts, and preparedness resources for the Town of Harmony, NC. Find emergency contacts, active alerts, and safety information for Harmony, North Carolina.",
		url: `${siteConfig.url}/emergency`,
	},
};
