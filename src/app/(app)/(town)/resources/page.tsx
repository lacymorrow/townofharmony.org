...
export const metadata: Metadata = {
	title: "Resident Resources | Town of Harmony, NC",
	description:
		"Documents, services, forms, and helpful links for residents of the Town of Harmony, NC. Find permits, ordinances, park reservations, and more.",
