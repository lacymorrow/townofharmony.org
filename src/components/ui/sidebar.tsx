  ...
  (
    ...
    return (
      ...
      >
        ...
        <div
          className={cn(
            "fixed bottom-0 top-[var(--sidebar-top,0px)] z-10 hidden h-[calc(100svh-var(--sidebar-top,0px))] w-[--sidebar-width] transition-[left,right,width] duration-200 ease-linear md:flex",
            side === "left"
