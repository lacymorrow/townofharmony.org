...
const INQUIRY_OPTIONS = [
	...
	{ value: "sewer-nonresidential-intown", label: "Sewer Nonresidential Service (In Town)" },
	{ value: "sewer-nonresidential-outtown", label: "Sewer Nonresidential Service (Out of Town)" },
