...
interface TownContactFormProps {
  ...
  // empty or whitespace values as unset and falls back to env/default.
    ...
    >
      ...
      >
        <div>
          ...
          <label
            htmlFor="attachment"
            className={`inline-block cursor-pointer rounded-lg border px-4 py-2 text-sm font-medium transition-colors ${
              errors.attachment
                ? "border-red-500 bg-red-50 text-red-700 hover:bg-red-100"
                : "border-[#DDD7CC] bg-white text-[#2D2A24] hover:bg-[#DDD7CC]/20"
            }`}
          >
            <svg
              aria-hidden="true"
