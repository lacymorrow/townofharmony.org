      ...
      <table width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;background:#fff;border:1px solid #DDD7CC;">
        ...
        <tr>
          <td style="background-color:${BRAND.primary};padding:28px 32px;">
            <p style="margin:0;color:${BRAND.accent};font-size:11px;letter-spacing:2px;text-transform:uppercase;">Town of Harmony · North Carolina</p>
        ...
        <tr>
          <td style="background-color:${BRAND.footer};padding:24px 32px;">
            <p style="margin:0 0 8px;color:#aaa;font-size:12px;">Town of Harmony — Official Contact Information</p>
            <p style="margin:0 0 4px;color:#ccc;font-size:12px;">3389 Harmony Hwy, Harmony, NC 28634</p>
            <p style="margin:0 0 4px;color:#ccc;font-size:12px;">Phone: (704) 546-2339 &nbsp;|&nbsp; Email: admin@townofharmony.org</p>
...
export function contactConfirmationEmail(opts: {
    ...
    <p style="margin:0;font-size:14px;color:${BRAND.text};">
      Call us at <strong>(704) 546-2339</strong> or email <a href="mailto:admin@townofharmony.org" style="color:${BRAND.primary};">admin@townofharmony.org</a> during office hours.
    </p>
  `;
...
export function townContactConfirmationEmail(opts: {
    ...
    <p style="margin:0 0 20px;font-size:15px;line-height:1.6;color:${BRAND.text};">
      Dear ${safeName}, thank you for contacting the Town of Harmony. We will respond to your inquiry within <strong>2 business days</strong>.
    </p>
    ...
    <p style="margin:0;font-size:14px;color:${BRAND.text};">
      Call us at <strong>(704) 546-2339</strong>, email <a href="mailto:admin@townofharmony.org" style="color:${BRAND.primary};">admin@townofharmony.org</a>, or visit us at 3389 Harmony Hwy, Harmony, NC 28634 during office hours (Mon–Fri, 8 AM–5 PM).
    </p>
  `;
